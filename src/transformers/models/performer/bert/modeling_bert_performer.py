...
_TOKENIZER_FOR_DOC = "BertPerformerTokenizer"
...
class BertPerformerPreTrainedModel(PreTrainedModel):
    """
...
class BertPerformerModel(BertPerformerPreTrainedModel):
    """
...
class BertPerformerForPreTraining(BertPerformerPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)

        self.bert = BertPerformerModel(config)
...
class BertPerformerLMHeadModel(BertPerformerPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.bert = BertPerformerModel(config, add_pooling_layer=False)
...
class BertPerformerForMaskedLM(BertPerformerPreTrainedModel):
...
class BertPerformerForNextSentencePrediction(BertPerformerPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
class BertPerformerForSequenceClassification(BertPerformerPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
class BertPerformerForMultipleChoice(BertPerformerPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
class BertPerformerForTokenClassification(BertPerformerPreTrainedModel):
...
class BertPerformerForQuestionAnswering(BertPerformerPreTrainedModel):
